...
channelInfo = (('BeginnerChallenges.txt', 555767513930268683),
               ('NoviceChallenges.txt', 576870446545371161),
               ('IntermediateChallenges.txt', 576870475955699758),
               ('AdvancedChallenges.txt', 576870519974920202),
               ('ExpertChallenges.txt', 576870496449069066))
        ...
        for channel in channelInfo:
            try:
                with open(channel[0]) as f:  # opens text file that contains challenges
                    ...
                    modActionsChannel = client.get_channel(577326085289803776)
                    text = f.read()
